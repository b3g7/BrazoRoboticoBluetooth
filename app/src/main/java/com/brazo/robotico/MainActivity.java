...
public class MainActivity extends Activity {
    ...
    private void crearInterfaz(){
        ...
        row.addView(left,new LinearLayout.LayoutParams(0,-1,1)); row.addView(right,new LinearLayout.LayoutParams(0,-1,1));
